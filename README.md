...
[![Tests](https://github.com/ensi-platform/laravel-elastic-query/actions/workflows/run-tests.yml/badge.svg?branch=v7)](https://github.com/ensi-platform/laravel-elastic-query/actions/workflows/run-tests.yml)
...
| ^0.3.2                                                                               | ^8.0 \|\| ^9.0                        | ^8.0 | 7.*           |
| ^7.0.0                                                                               | ^8.0 \|\| ^9.0                        | ^8.0 | 7.*           |
| ^7.0.11                                                                              | ^8.0 \|\| ^9.0 \|\| ^10.0             | ^8.0 | 7.*           |
| ^7.0.21                                                                              | ^8.0 \|\| ^9.0 \|\| ^10.0 \|\| ^11.0  | ^8.0 | 7.*           |
| ^7.1.0                                                                               | ^9.0 \|\| ^10.0 \|\| ^11.0            | ^8.1 | 7.*           |
| ^7.2.3                                                                               | ^9.0 \|\| ^10.0 \|\| ^11.0 \|\| ^12.0 | ^8.1 | 7.*           |
| ^8.x ([see details](https://github.com/ensi-platform/laravel-elastic-query/tree/v8)) | ^9.0 \|\| ^10.0 \|\| ^11.0            | ^8.1 | 8.*           |
